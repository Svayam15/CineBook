...
import {
  ...
  LayoutDashboard, Film, Theater, Tv,
  BookOpen, Users, Ticket, ScanLine,
    ...
    <div className="min-h-screen bg-gray-100 pb-24">
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <Card>
            <Row icon={LayoutDashboard} label="Dashboard"      to="/admin" />
            <Row icon={Film}           label="Movies"          to="/admin/movies" />
            <Row icon={Theater}        label="Theatres"        to="/admin/theatres" />
            <Row icon={Tv}             label="Shows"           to="/admin/shows" />
            <Row icon={BookOpen}       label="Bookings"        to="/admin/bookings" />
            <Row icon={Users}          label="Users"           to="/admin/users" />
            <Row icon={Ticket}         label="Window Booking"  to="/admin/window-booking" />
            <Row icon={ScanLine}       label="Scanner"         to="/admin/scanner" />
          </Card>
        </div>
