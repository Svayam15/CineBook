...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero */}
      <div className="bg-gradient-to-b from-primary/10 to-gray-50 px-6 py-16">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="font-heading text-4xl md:text-6xl font-bold text-gray-900 mb-4 leading-tight">
          ...
          <div className="flex items-center justify-center gap-3 mb-10">
            ...
            <Link
              to="/login"
              className="flex items-center gap-2 bg-white border border-gray-200 text-gray-900 hover:border-primary/50 font-medium px-6 py-3 rounded-xl transition"
            >
              Login
            </Link>
          </div>
          ...
          <div className="relative max-w-md mx-auto">
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 text-gray-900 rounded-2xl pl-11 pr-4 py-3 outline-none focus:border-primary transition text-sm placeholder:text-gray-400"
            />
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-medium transition
              ${activeTab === "shows" ? "bg-primary text-white" : "bg-white border border-gray-200 text-gray-600 hover:text-gray-900"}`}
          >
            <Tv size={16} />
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-medium transition
              ${activeTab === "movies" ? "bg-primary text-white" : "bg-white border border-gray-200 text-gray-600 hover:text-gray-900"}`}
          >
            <Film size={16} />
        ...
        {loading ? (
          ...
          filteredShows.length === 0 ? (
            <div className="text-center py-16">
              <Tv size={40} className="text-gray-300 mx-auto mb-3" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredShows.map((show) => (
                <div
                  key={show.id}
                  className="bg-white border border-gray-100 rounded-2xl p-5 hover:border-primary/50 transition group"
                >
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="text-gray-900 font-semibold font-heading group-hover:text-primary transition">
                      {show.movie?.title}
                    </h3>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    <div>
                      <p className="text-gray-900 font-semibold">₹{show.regularPrice}</p>
                      {show.hasGoldenSeats && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredMovies.map((movie) => (
                ...
                >
                  ...
                  <h3 className="text-gray-900 font-semibold font-heading mb-1">{movie.title}</h3>
